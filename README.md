...
Symbolverse then mechanically checks whether each step can *structurally* follow from the previous ones — or **refuses** if it cannot — all before running the workflow.
